...
const Chart = (props) => {
  ...
  if (props.marketData) {
    for (const [key, value] of Object.entries(props.marketData)) {
      const object = {};
      object["name"] = key;
  ...
  const renderLineChart = (
    ...
    >
      ...
      <Line type="monotone" dataKey="2a. high (ILS)" stroke="#82ca9d" />
      <Line type="monotone" dataKey="3a. low (ILS)" stroke="#8884d8" />
    </LineChart>
  );
